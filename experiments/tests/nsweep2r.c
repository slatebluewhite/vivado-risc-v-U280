...
int main(int argc,char**argv){
  g=fopen(argc>1?argv[1]:"/mnt2/tmp/nsweep2r.log","w");
  ...
  mark("=== E312c [N 순서만 반전: 1024가 첫 호출] BERT-large 단계 [1024xN] 패딩 검정 (블록 (8,4), M=128) ===");
  mark("%11s %6s %4s %5s | %9s %9s %9s | %11s | %s",
       "형상","블록","Kc","청크","m=1","m=2","m=3","η(2) η(3)","정확성");
  MM=128; KK=1024; BI=8; BJ=4;
  int NS[]={1024,960,1088,1152,1216};  /* 1024를 맨 앞으로 — 순서만 다름 */
