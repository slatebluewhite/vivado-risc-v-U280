// kcnk.c — E419: `N >= 4K` 문턱이 M=512에서도 맞는가. 사전 등록: PREREG_E419.txt
// M=512, K=1536 고정(A=768KB 상수), N만 바꿔 N/K = 2/3/4/6.
...
int main(int argc,char**argv){
  g=fopen(argc>1?argv[1]:"/mnt2/tmp/kcnk.log","w");
  ...
  mark("=== E419: M=512의 N/K 곡선 — 문턱이 밀렸는가 ===");
