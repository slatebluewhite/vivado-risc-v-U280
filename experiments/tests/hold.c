// hold.c — 현재 상태에서 적합한 모델의 홀드아웃 검정 (E256).
// 사전 등록: experiments/model/PREREG_E256.txt (여섯 형상 전부 m=2 최적으로 예측).
// 훈련(24점)에 없는 K={512,2304,2816}, N={1728,2880}. N은 nj가 6의 배수라 불균형 1.0.
//
...
int main(int argc,char**argv){
  ...
  mark("=== 홀드아웃 (3i8f50 현재 상태, M=128, (4,6), Kc=16, best-of-5) ===");
  mark("사전 등록 예측: 여섯 형상 전부 m=2 최적");
  mark("%11s %4s %8s | %9s %9s %9s | %11s | %s",
       "형상","nj","루프라인","m=1","m=2","m=3","η(2) η(3)","정확성");
  int Ks[]={512,2304,2816}, Ns[]={1728,2880};
