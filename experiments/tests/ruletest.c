// ruletest.c — E277 규칙의 표본 밖 검정 (E278).
// 사전 등록: experiments/model/PREREG_E278.txt  훈련 10형상과 겹치지 않는 6형상.
...
int main(int argc,char**argv){
  ...
  mark("=== E277 규칙 표본 밖 검정 (권장 구성, M=128, best-of-5) ===");
  ...
  MM=128;
  struct { int K,N; } SH[]={{1536,768},{1536,1536},{768,1536},
                            {2560,1280},{1536,6144},{640,2560}};
  int BLI[]={8,4,4}, BLJ[]={4,4,8};
  int CH[]={2,4,8};
  for(unsigned h=0;h<6;h++){ KK=SH[h].K; NN=SH[h].N;
    int Ktil=KK/16;
