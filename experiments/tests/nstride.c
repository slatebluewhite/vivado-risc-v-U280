...
static int8_t C[MMAX*2048] __attribute__((aligned(64)));
static int8_t REF[MMAX*2048];
static int MM,KK,NN;
...
int main(int argc,char**argv){
  g=fopen(argc>1?argv[1]:"/mnt2/tmp/nstride.log","w");
  ...
  mark("=== E312 일량 고정(N=1024), 스트라이드만 변경 (K=1024, (8,4), Kc=32, M=128) ===");
