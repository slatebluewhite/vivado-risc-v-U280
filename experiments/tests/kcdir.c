// kcdir.c — E403: "청크를 줄여라"는 방향이 형상에 따라 뒤집히는가.
//
...
int main(int argc,char**argv){
  g=fopen(argc>1?argv[1]:"/mnt2/tmp/kcdir.log","w");
  ...
  mark("=== E403: FFN1 세 형상의 Kc 방향 (블록 (8,8) 고정, best-of-3) ===");

  static const int KCs1[]={6,8,12,16,24,48,0};
  static const int KCs2[]={8,16,32,64,0};
  static const int KCs3[]={12,16,24,32,48,0};   /* Kc=96은 sp 1536 > 1024 불법 */
  struct { int K,N; const int *kcs; const char *nm; } S[] = {
    {  768,3072, KCs1, "BERT-base FFN1" },
    { 1024,4096, KCs2, "BERT-large FFN1" },
    { 1536,6144, KCs3, "h1536 FFN1" },
  };
