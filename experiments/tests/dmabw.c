...
#define FREQ 50.0e6
#define ROWS 4096                 // 4096행 x 192B = 786KB 소스 (L2 512KB보다 큼)
#define W    192
#define NTILE 1024                // 가속기당 옮길 타일 수
#define SLOTS 16
...
int main(int argc, char **argv){
  g=fopen(argc>1?argv[1]:"/mnt2/tmp/dmabw.log","w");
  ...
  mark("=== DMA만 돌렸을 때의 천장 (3i8f50, 128비트 버스 = 16 B/cycle) ===");
