// kcdir4.c — E406: 2청크/4청크를 가르는 것이 K*N인지 검정. 사전 등록: PREREG_E406.txt
//   [1024x3072] Ktil= 64 : Kc  8 16 24 32 48 64  (청크 8 4 3 2 2 1)
//   [3072x1024] Ktil=192 : Kc 16 24 32 48 64     (청크 12 8 6 4 3)
//   [1792x1792] Ktil=112 : Kc 14 16 28 32 56 64  (청크 8 7 4 4 2 2)
// 셋 다 K*N = 3.0 MB (앞 두 무리 2.25 / 4.00 MB의 기하 중간). 블록 (8,8), m=1·m=3.
#define _GNU_SOURCE
#include <stdio.h>
#include <stdlib.h>
#include <stdarg.h>
...
int main(int argc,char**argv){
  g=fopen(argc>1?argv[1]:"/mnt2/tmp/kcdir4.log","w");
  ...
  mark("=== E406: K*N=3.0MB 종횡비 셋의 Kc 방향 (블록 (8,8) 고정, best-of-3) ===");

  static const int KCs1[]={8,16,24,32,48,64,0};
  static const int KCs2[]={16,24,32,48,64,0};
  static const int KCs3[]={14,16,28,32,56,64,0};
  struct { int K,N; const int *kcs; const char *nm; } S[] = {
    { 1024,3072, KCs1, "N/K=3" },
    { 3072,1024, KCs2, "K/N=3" },
    { 1792,1792, KCs3, "1:1" },
  };
