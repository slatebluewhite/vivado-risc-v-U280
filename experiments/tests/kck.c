// kck.c — E421: N/K=3 선 위에서 K를 훑는다. 사전 등록: PREREG_E421.txt
// K = 768/1024/1280/1536/2048 (N = 3K), M=256. K=768은 Kc=24(규칙)와 12(청크4 대조) 둘 다.
...
int main(int argc,char**argv){
  g=fopen(argc>1?argv[1]:"/mnt2/tmp/kck.log","w");
  ...
  mark("=== E421: N/K=3 선 위의 K 훑기 (M=256) ===");

  struct { int M,K,N; int I,J,kc; } C4[] = {
    {  256,  768, 2304,  8,8,  24},
    {  256,  768, 2304, 16,4,  24},
    {  256, 1024, 3072,  8,8,  16},
    {  256, 1024, 3072, 16,4,  16},
    {  256, 1280, 3840,  8,8,  20},
    {  256, 1280, 3840, 16,4,  20},
    {  256, 1536, 4608,  8,8,  24},
    {  256, 1536, 4608, 16,4,  24},
    {  256, 2048, 6144,  8,8,  32},
    {  256, 2048, 6144, 16,4,  32},
    {  256,  768, 2304,  8,8,  12},
    {  256,  768, 2304, 16,4,  12},
  };
  int lastK=0,lastN=0;
