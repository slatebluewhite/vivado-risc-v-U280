// kcnk2.c — E420: 교차점이 M을 따라 움직이는가, K 착시였나. 사전 등록: PREREG_E420.txt
// K=1536 고정, M = 256/512, N/K = 2/3/4/6 의 2x4 격자. E419의 M=512 행도 같이 다시 잰다.
...
int main(int argc,char**argv){
  g=fopen(argc>1?argv[1]:"/mnt2/tmp/kcnk2.log","w");
  ...
  mark("=== E420: K=1536 고정, M x N/K 격자 — 교차가 M을 따라 움직이는가 ===");

  struct { int M,K,N; int I,J,kc; } C4[] = {
    {  256, 1536, 3072,  8,8,  24},
    {  256, 1536, 3072, 16,4,  24},
    {  256, 1536, 4608,  8,8,  24},
    {  256, 1536, 4608, 16,4,  24},
    {  256, 1536, 6144,  8,8,  24},
    {  256, 1536, 6144, 16,4,  24},
    {  256, 1536, 9216,  8,8,  24},
    {  256, 1536, 9216, 16,4,  24},
    {  512, 1536, 3072,  8,8,  24},
    {  512, 1536, 3072, 16,4,  24},
    {  512, 1536, 4608,  8,8,  24},
    {  512, 1536, 4608, 16,4,  24},
    {  512, 1536, 6144,  8,8,  24},
    {  512, 1536, 6144, 16,4,  24},
    {  512, 1536, 9216,  8,8,  24},
    {  512, 1536, 9216, 16,4,  24},
  };
  int lastK=0,lastN=0;
