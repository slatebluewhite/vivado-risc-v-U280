// bert6.c — E410: BERT-base 층 블록 전수를 **새 Kc 규칙**(E406/E408)으로 다시 훑는다.
// measured.py의 표는 옛 Kc로 잰 것이라 도구가 권하는 조합을 채점할 수 없었다(E407 주석).
// 규칙이 이 워크로드에 주는 (단계, 블록)별 Kc:
//   QKV·출력 Kc=24   FFN1 Kc=24   FFN2 (4,4)Kc=96 나머지 Kc=64
...
int main(int argc, char **argv){
  g=fopen(argc>1?argv[1]:"/mnt2/tmp/bert6.log","w");
  ...
  mark("=== E410: BERT-base 블록 전수 — 새 Kc 규칙 (3가속기+mem2) ===");
