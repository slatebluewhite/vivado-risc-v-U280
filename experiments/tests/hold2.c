// hold2.c — p-노름 모델의 진짜 홀드아웃 (E258).
// 사전 등록: experiments/model/PREREG_E258.txt
// N=864/1440/2016은 훈련에 없는 N(보간), K=3584는 훈련 최대 3072를 넘음(외삽).
//
...
int main(int argc,char**argv){
  ...
  mark("=== 홀드아웃 2 (3i8f50 현재 상태, M=128, (4,6), Kc=16, best-of-5) ===");
  mark("보간 6점 예측 최적m: 3,3,2,2,2,2 / 외삽 2점: 2,2");
  mark("%11s %4s %8s | %9s %9s %9s | %11s | %s",
       "형상","nj","루프라인","m=1","m=2","m=3","η(2) η(3)","정확성");
  struct { int K,N; } S[]={{1024,864},{1024,1440},{1024,2016},
                           {2048,864},{2048,1440},{2048,2016},
                           {3584,1152},{3584,2880}};
