// corner.c — 가법 분리성이 (큰 K, 작은 N) 모서리에서 깨지는가 (E247).
//
...
int main(int argc,char**argv){
  ...
  mark("=== 분리성의 모서리 검정 (3i8f50, M=128, (4,6), Kc=16, best-of-3) ===");
  mark("N은 nj가 6의 배수(6/12/24) -> m=2,3 모두 불균형 정확히 1.0, 꼬리 블록 없음");
  mark("%11s %4s %8s | %9s %9s %9s | %11s | %s",
       "형상","nj","루프라인","m=1","m=2","m=3","η(2) η(3)","정확성");
  int Ks[]={256,768,2048,3072}, Ns[]={576,1152,2304};
