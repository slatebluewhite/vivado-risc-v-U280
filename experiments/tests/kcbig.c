...
int main(int argc,char**argv){
  ...
  mark("=== E395: 규칙이 권하는 큰 Kc를 잰다 (3가속기+mem2, best-of-4) ===");
  mark("%13s %5s %6s %5s %6s | %9s %9s %9s | %5s | %s",
       "형상","블록","Kc","청크","sp","m=1","m=2","m=3","η(3)","정확성");

  /* (1) [8192x2048]: 1순위 (4,4) Kc=128 을 Kc=64·32 및 다른 블록과 비교 */
  KK=8192; NN=2048; fill();
  mark("--- [8192x2048]  규칙 1순위는 (4,4) Kc=128 (4청크) ---");
  BI=4;BJ=4; KCv=128; one();
  BI=4;BJ=4; KCv=64;  one();
  BI=4;BJ=4; KCv=32;  one();
  BI=8;BJ=8; KCv=64;  one();
  BI=8;BJ=4; KCv=64;  one();

  /* (2) [3072x3072]: 1순위 (8,8) Kc=48 을 Kc=32·24와 비교 */
  KK=3072; NN=3072; fill();
  mark("--- [3072x3072]  규칙 1순위는 (8,8) Kc=48 (4청크) ---");
  BI=8;BJ=8; KCv=48; one();
  BI=8;BJ=8; KCv=32; one();
  BI=8;BJ=8; KCv=24; one();
  BI=8;BJ=4; KCv=48; one();
  BI=4;BJ=4; KCv=48; one();
  mark("=== E395_DONE ===");
  return 0; }
