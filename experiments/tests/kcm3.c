// kcm3.c — E415: (16,4) 곡선의 표본 밖 검정. 사전 등록: PREREG_E415.txt
// K=1024 고정(A=256KB 상수)으로 N/K=3,6만 잰다. E414에서는 N/K가 클수록 A가 작아서
// A 크기가 숨은 변수일 수 있었다 — 여기서 가른다.
#define _GNU_SOURCE
#include <stdio.h>
#include <stdlib.h>
#include <stdarg.h>
...
int main(int argc,char**argv){
  g=fopen(argc>1?argv[1]:"/mnt2/tmp/kcm3.log","w");
  ...
  mark("=== E415: (16,4) 곡선 표본 밖 검정, K=1024 고정 (best-of-3) ===");
