// ffn1.c — FFN1로 B_dram의 결정 요인을 가른다 (E204).
// FFN1 [128x768]x[768x3072]: 가중치 2.36MB(FFN2와 같음), K=768(projection과 같음).
// [예측] B_dram이 가중치 크기로 정해지면 약 2.78, K로 정해지면 약 4.75가 나온다.
